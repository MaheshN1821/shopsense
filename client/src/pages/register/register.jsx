  ...
  return (
    <div className="regFormCont">
      ...
      <div className="regContainer">
        <div className="regHeading">SignUp</div>
        <form onSubmit={handleSubmit(onSubmit)} className="form">
          ...
          {errors.username && (
            <span className="errReg">{errors.username.message}</span>
          )}
          <div className="input-field contPos">
            <input
              type="email"
          ...
          {errors.email && (
            <span className="errReg">{errors.email.message}</span>
          )}
          <div className="input-field contPos">
            <input
          ...
          {errors.password && (
            <span className="errReg">{errors.password.message}</span>
          )}
