  ...
  const onSubmit = async (data) => {
    try {
      const response = await axios.post(
        "https://shopsense-backend.vercel.app/auth/seller/login",
        JSON.stringify(data),
        {
          headers: {
      ...
      sessionStorage.setItem("sellerName", response.data.info.username);
      response.status === 200 ? Navigate("/seller/details") : "";
    } catch (err) {
