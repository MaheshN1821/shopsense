...
function SellerAddBooks() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await axios.post("http://localhost:3000/products/add/books", data);
      notifySuccess();
    } catch (error) {
      ...
      <div className="sellerDetailsMainAddShirt">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="shirt-form">
          <div className="shirt-gender-cont">
            ...
            {errors.bookType && <p className="">Book Type is required.</p>}
          </div>
