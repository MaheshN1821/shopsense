...
import "./sellerAddShirt.css";
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

function SellerAddWatches() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await axios.post("http://localhost:3000/products/add/watches", data);
      notifySuccess();
    } catch (error) {
      ...
      <div className="sellerDetailsMainAddShirt">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="shirt-form">
          <div className="shirt-gender-cont">
            ...
            {errors.for && <p className="">Gender is required.</p>}
          </div>
          <div className="shirt-gender-cont">
            <label className="">Watches Type</label>
            <select
              {...register("watchType", { required: true })}
              className="shirt-gender"
              required
            >
              <option value=""></option>
            ...
            {errors.watchType && <p className="">Watch Type is required.</p>}
          </div>
          <div className="size-cont">
            ...
            >
              ...
              <option value="smallDial">Small Dial</option>
              <option value="mediumDial">Medium Dial</option>
              <option value="largeDial">Large Dial</option>
            </select>
          </div>
...
export default SellerAddWatches;
