...
function SellerAddFootwear() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await axios.post("http://localhost:3000/products/add/footwear", data);
      notifySuccess();
    } catch (error) {
    ...
    <div className="sellerDetailsContAddShirt">
      ...
      <div className="sellerDetailsMainAddShirt">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="shirt-form">
          ...
          <div className="shirt-gender-cont">
            <label className="">FootWear Type</label>
            <select
              {...register("footWearType", { required: true })}
              className="shirt-gender"
              required
            >
              <option value=""></option>
            ...
            {errors.footWearType && (
              <p className="">Foot Wear Type is required.</p>
            )}
          </div>
...
export default SellerAddFootwear;
