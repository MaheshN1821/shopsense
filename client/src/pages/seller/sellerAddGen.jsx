...
import "./sellerAddGen.css";
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

function SellerAddGen() {
      ...
      <div className="sellerDetailsMainAddShirt">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="shirt-form">
          ...
          <div className="prod-type-cont">
            ...
            {errors.prodType && <p className="">Product Type is required.</p>}
          </div>
